...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>HOME|AUTHOR'S CUISINE KAMA</title>
            ...
            <div class="socials">
                <ul class="new icons">
                    <ul class="whatsapp-icon">
                        <li style="margin-right: 1.1em;"><a href="https://www.api.whatsapp.com/0785740523" class="fa fa-whatsapp"></a></li> 
                    </ul>
                    <li><a href="#" class="fa fa-phone"></a></li><span style="color: white;">+256785740523 </span>  
                </ul>
            </div>
            <div class="socials">
                <ul class="new icons">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            ...
                            <div class="carousel-caption">
                                <h2 class="animated fadeInLeft">Local Fresh Meals</h2>
                                <p class="animated fadeInUp">Order  Your Favourites & Enjoy the Day With  Us</p>
                                <p class="animated fadeInUp"><a href="./order.php" class="btn btn-transparent btn-rounded btn-large">Order Now</a></p>
                            </div>
                        </div>
                        <div class="carousel-item">
                            ...
                            <div class="carousel-caption">
                                ...
                                <p class="animated fadeInUp">Choose Your own Dinning room of Your Choice</p>
                                <p class="animated fadeInUp"><a href="./order.php" class="btn btn-transparent btn-rounded btn-large">Order Now</a></p>
                            </div>
                        </div>
                        <div class="carousel-item">
                            ...
                            <div class="carousel-caption">
                                <h2 class="animated fadeInRight">Nice Sauce & Spices</h2>
                                <p class="animated fadeInRight">Enjoy your money in a Confortable Way at Restaurant Author's Cuisine Kama</p>
                                <p class="animated fadeInRight"><a href="./order.php" class="btn btn-transparent btn-rounded btn-large">Order Now</a></p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group">
                                        <div class="input-group date"  data-target-input="nearest">
                                            <input  type="text" class="form-control" placeholder="No.of People" data-target="#time"/>
