        ...
        <div class="container">
            ...
            <section id="checkout">
                <div class="container">
                    ...
                    <form action="./routes/store-register-products.php" method="post" autocomplete="off">
                    <div class="row form">
                        <div class="col-md-12">

                        <div class="form-group">
                    
                            <input type="file" alt="" width="50%" height="50%" name="menu_image" style="margin-left: 16em;">
                            </div>
